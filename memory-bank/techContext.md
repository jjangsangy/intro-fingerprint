...
- **Libraries**:
    ...
    - `fftw3f`: Fast Fourier Transform library for optimized audio processing. **Enabled by default.** Note: On macOS, this is currently supported only on ARM64 (Apple Silicon) architectures.
