...
--   - 'libfftw3' is optional. If available and configured, it provides faster FFT processing.
--
-- Key Bindings:
...
--      - Performs FFT using either libfftw3 (if available) or an optimized Stockham Radix-4 Autosort algorithm.
...
--      - Audio FFT:
--          - Supports 'libfftw3' for maximum performance (requires 'audio_use_fftw = "yes"').
--          - Fallback (FFI Path):
