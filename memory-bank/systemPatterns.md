...
- **Normalization**: Applies mandatory `dynaudnorm` filter to the audio stream. This ensures consistent spectral peaks regardless of source volume or original mixing, making the algorithm volume-invariant.
- **Processing**:
    - FFT:
